...
<?php
  ...
  $query = "SELECT League_name, Team_name, wins, losses
  FROM League AS L, Team AS T, Team_season AS S
  WHERE (L.League_ID = T.League_ID) AND (T.Team_ID = S.Team_ID) AND (Season_year = $searchYear) AND (League_name = '$league')
  ORDER BY wins DESC;";
